...
<html lang="en">
   ...
   <body class="main-layout footer_to90 about_page">
            ...
            <div class="header_top d_none1">
               <div class="container">
                  <div class="row">
                     <div class="col-md-4">
                        <ul class="conta_icon">
                           <li><a href="#"><img src="images/call.png" alt="#"/>Call us: 0991 - 234 - 1234</a> </li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <div class="se_fonr1">
                           ...
                           <span class="time_o"> Open hour: 8.00 - 20.00</span>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="header_midil">
               <div class="container">
                  <div class="row d_flex">
                     ...
                     <div class="col-md-4">
                        <a class="logo" href="index.html"><img src="images/TechBeats.png" alt="#" width="150"></a>
                     </div>
                     <div class="col-md-4">
      ...
      <div class="col-md-4">
        <a href="#" class="sign" >Add New Data</a>

      </div>
      <?php
            $db = new PDO('mysql:host=localhost;dbname=test', 'root', '');
            $stmt = $db->query('SELECT id, product, num_prod FROM inventory');
